...
BLOG_TITLE = "ntoll.org"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ntoll.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ntoll.org/"
BLOG_EMAIL = "ntoll@ntoll.org"
BLOG_DESCRIPTION = "Everything I say is false..."  # (translatable)
...
POSTS = (
    ("posts/*.rst", "article", "post.tmpl"),
    ("posts/*.md", "article", "post.tmpl"),
    ("posts/*.txt", "article", "post.tmpl"),
    ("posts/*.html", "article", "post.tmpl"),
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
...
# (translatable)
CONTENT_FOOTER = '<p>Contents &copy; {date}         <a href="mailto:{email}">{author}</a></p> {license}'
