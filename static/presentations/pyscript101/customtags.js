"use strict";
/******************************************************************************
An example of how to do a custom "third party" plugin for PolyScript.
...
const polyReplTag = function(e) {
    ...
    */
    ...
    const plugin = {
        ...
        configure: function(config) {
            ...
            xtermElement.onload = function(e) {
                const polyXtermLoaded = new CustomEvent("poly-xterm-loaded");
                document.dispatchEvent(polyXtermLoaded);
            };
            var head = document.getElementsByTagName('head')[0];
            head.appendChild(xtermElement);
            document.addEventListener("poly-xterm-loaded", onLoaded);
        },
        start: function(config) {
            ...
            customElements.define("poly-repl", PolyREPL);
        },
    ...
    window.polyScript.registerPlugin(plugin);
};
document.addEventListener("poly-configured", polyReplTag);
