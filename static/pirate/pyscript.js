...
const main = function() {
    ...
    **************************************************************************/
    ...
    try {
        plug = polyplug();
        logger("Found PolyPlug. 👋🦜🔌");
    } catch (err) {
        logger("Missing PolyPlug. ⁉️🦜🔌"); 
    }
    ...
    class Interpreter {
        ...
        */
        ...
        static ready() {
            ...
            */
            ...
            document.addEventListener("polyplugSend", function(e) {
                const script = {
                    code: "receive(" + JSON.stringify(e.detail) + ")"
                };
        ...
        static print(output) {
            /*
            Handle output printed by the Python runtime.
            */
                ...
                class PyScript extends HTMLElement {
                    connectedCallback() {
                        ...
                        */
                        ...
                        document.addEventListener("polyplugStdout", onPrint);
                    }
                }
